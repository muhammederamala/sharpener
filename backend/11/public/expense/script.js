...
function createExpenseElement(expense) {
    ...
    editButton.addEventListener('click', function () {
        ...
        editExpense(expense._id); // Pass the expense ID as an argument
    });
    ...
    deleteButton.addEventListener('click', function () {
        ...
        deleteExpense(expense._id); // Pass the expense ID as an argument
    });
...
async function loadExpenses() {
    try {
        ...
        .get(`${baseURL}/load-expense?userId=${userId}&page=${currentPage}&pageSize=${pageSize}`,{
